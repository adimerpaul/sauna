...
$id=$ff[0];
mysql_query("INSERT INTO detalle VALUES('null','INDIVIDUALES MAYORES','$imac','5','$ima','$id')");
mysql_query("INSERT INTO detalle VALUES('null','INDIVIDUALES MENORES','$imec','2.5','$ime','$id')");
