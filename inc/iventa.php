...
$id=$ff[0];
mysql_query("INSERT INTO detalle VALUES('null','INDIVIDUALES MAYORES','$imac','8','$ima','$id')");
mysql_query("INSERT INTO detalle VALUES('null','INDIVIDUALES MENORES','$imec','4','$ime','$id')");
