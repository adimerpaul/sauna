...
<div class="panel panel-default">
  <div class="row">
    ...
    <div class="col-xs-3 panel-body">
      <button type="button" class="btn btn-success" data-toggle="modal" data-target="#exampleModal" data-whatever="1">Inicio</button>
      <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#detener" data-whatever="1">Fin</button>
    </div>
  </div>
  <div class="row">
    <div class="col-xs-1">
    ...
    <div class="col-xs-3 panel-body">
      <button type="button" class="btn btn-success" data-toggle="modal" data-target="#exampleModal" data-whatever="2">Inicio</button>
      <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#detener" data-whatever="2">Fin</button>
    </div>
  </div>
  <div class="row">
    <div class="col-xs-1">
    ...
    <div class="col-xs-3 panel-body">
      <button type="button" class="btn btn-success" data-toggle="modal" data-target="#exampleModal" data-whatever="3">Inicio</button>
      <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#detener" data-whatever="3">Fin</button>
    </div>
  </div>
  <div class="row">
    <div class="col-xs-1">
    ...
    <div class="col-xs-3 panel-body">
      <button type="button" class="btn btn-success" data-toggle="modal" data-target="#exampleModal" data-whatever="4">Inicio</button>
      <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#detener" data-whatever="4">Fin</button>
    </div>
  </div>
  <div class="row">
    <div class="col-xs-1">
    ...
    <div class="col-xs-3 panel-body">
      <button type="button" class="btn btn-success" data-toggle="modal" data-target="#exampleModal" data-whatever="5">Inicio</button>
      <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#detener" data-whatever="5">Fin</button>
    </div>
  </div>
</div>
-->
        ...
        <form action="inc/isauna.php" method="POST">
          ...
          <div class="form-group">
            ...
            <select class="form-control" id="tipo" name="tipo">
              <option value="SAUNA MAYORES ESPACIAL">SIMPLE/5Bs.</option>
            </select>
          </div>
